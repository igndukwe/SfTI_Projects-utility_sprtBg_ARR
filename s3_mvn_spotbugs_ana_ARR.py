...
# srun python s2_chk_styl_ana_app_ARR.py -t 577 -pd ../my_codesnippet_analysis/SpotBugs1/mvn_apps -upd -cf ../my_codesnippet_analysis/CheckStyle1/compilesnippets_java -ucf -ncf ../my_codesnippet_analysis/SpotBugs1/spotbugserrorcodesnippets_java -lf ../my_codesnippet_analysis/SpotBugs1/spotbugs_logs.txt

# srun python s2_chk_styl_ana_app_ARR.py -idx "${SLURM_ARRAY_TASK_ID}" -t 577 -crd ../my_codesnippet_analysis/SpotBugs1 -ucrd -pd mvn_apps -upd -ncf spotbugserrorcodesnippets_java -lf spotbugs_logs.txt
...
#e.g. ../my_codesnippet_analysis/SpotBugs1/spotbugs_logs.txt
...
#e.g., ../my_codesnippet_analysis/SpotBugs1/spotbugserrorcodesnippets_java
#e.g., spotbugserrorcodesnippets_java  (if usecommonrootdir is true)
parser.add_argument(
    "-cf",
    "--compilefiles",
...
#e.g., ../my_codesnippet_analysis/SpotBugs1/checkstyleerrorsnippets_java
...
def run_chk_styl_analysis():
    ...
    while error:
        ...
        compile_pkg_cmd = 'cd {}; mvn spotbugs:spotbugs'.format(app_name_full_dest_path)
        cmd1 = sp.run(
